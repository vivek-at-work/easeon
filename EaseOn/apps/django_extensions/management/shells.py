...
if DJANGO_VERSION < (1, 10):
    SHELL_PLUS_DJANGO_IMPORTS.update({'django.core.urlresolvers': ['reverse']})
else:
    SHELL_PLUS_DJANGO_IMPORTS.update({'django.urls': ['reverse']})
    ...
    for directive in import_directives:
        try:
            ...
            try:
                ...
                if not quiet_load:
                    print(
                        style.ERROR('Unable to import %r from %r' % directive)
                    )
