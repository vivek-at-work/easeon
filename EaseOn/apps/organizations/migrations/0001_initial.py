    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'gsx_ship_to',
                    models.CharField(default='IST', max_length=20),
                ),
                (
                    'created_by',
                    models.ForeignKey(
                ...
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.DO_NOTHING,
                        related_name='modified_organization',
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        editable=False,
                        on_delete=django.db.models.deletion.DO_NOTHING,
                        related_name='created_organizationrights',
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.DO_NOTHING,
                        related_name='modified_organizationrights',
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                through='organizations.OrganizationRights',
                to=settings.AUTH_USER_MODEL,
            ),
        ),
