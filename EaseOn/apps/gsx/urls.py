...
attachment_upload_access = GSXViewSet.as_view(
    {'post': 'attachment_upload_access'}
)
...
urlpatterns = [
    ...
    url(
        r'content_article_lookup',
        content_article_lookup,
        name='content_article_lookup',
    ),
