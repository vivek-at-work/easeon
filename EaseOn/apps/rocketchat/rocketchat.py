...
class RocketChat:
    ...
    def __init__(
        self,
        user=settings.CHAT_SERVICE_ADMIN,
        password=settings.CHAT_SERVICE_ADMIN_PASSWORD,
        auth_token=None,
        user_id=None,
        server_url=settings.CHAT_SERVICE_URL,
        ssl_verify=False,
        proxies=None,
        timeout=30,
        session=None,
    ...
    def users_update(self, user_id, **kwargs):
        ...
        return self.__call_api_post(
            'users.update', userId=user_id, data=kwargs
        )
    ...
    def channels_create(self, name, **kwargs):
        ...
        return self.__call_api_post(
            'channels.create', name=name, kwargs=kwargs
        )
    ...
    def groups_history(self, room_id, **kwargs):
        ...
        return self.__call_api_get(
            'groups.history', roomId=room_id, kwargs=kwargs
        )
    ...
    def groups_moderators(self, room_id=None, group=None, **kwargs):
        ...
        if room_id:
            return self.__call_api_get(
                'groups.moderators', roomId=room_id, kwargs=kwargs
            )
        elif group:
            return self.__call_api_get(
                'groups.moderators', roomName=group, kwargs=kwargs
            )
        else:
    ...
    def groups_archive(self, room_id, **kwargs):
        ...
        return self.__call_api_post(
            'groups.archive', roomId=room_id, kwargs=kwargs
        )

    def groups_unarchive(self, room_id, **kwargs):
        """Unarchives a private group."""
        return self.__call_api_post(
            'groups.unarchive', roomId=room_id, kwargs=kwargs
        )
    ...
    def groups_close(self, room_id, **kwargs):
        ...
        return self.__call_api_post(
            'groups.close', roomId=room_id, kwargs=kwargs
        )
    ...
    def groups_info(self, room_id=None, room_name=None, **kwargs):
        ...
        if room_id:
            return self.__call_api_get(
                'groups.info', roomId=room_id, kwargs=kwargs
            )
        elif room_name:
            return self.__call_api_get(
                'groups.info', roomName=room_name, kwargs=kwargs
            )
        else:
    ...
    def groups_delete(self, room_id=None, group=None, **kwargs):
        ...
        if room_id:
            return self.__call_api_post(
                'groups.delete', roomId=room_id, kwargs=kwargs
            )
        elif group:
            return self.__call_api_post(
                'groups.delete', roomName=group, kwargs=kwargs
            )
        else:
            raise RocketMissingParamException('roomId or group required')
    ...
    def groups_members(self, room_id=None, group=None, **kwargs):
        ...
        if room_id:
            return self.__call_api_get(
                'groups.members', roomId=room_id, kwargs=kwargs
            )
        elif group:
            return self.__call_api_get(
                'groups.members', roomName=group, kwargs=kwargs
            )
        else:
            raise RocketMissingParamException('roomId or group required')
    ...
    def groups_roles(self, room_id=None, room_name=None, **kwargs):
        ...
        if room_id:
            return self.__call_api_get(
                'groups.roles', roomId=room_id, kwargs=kwargs
            )
        elif room_name:
            return self.__call_api_get(
    ...
    def groups_files(self, room_id=None, room_name=None, **kwargs):
        ...
        if room_id:
            return self.__call_api_get(
                'groups.files', roomId=room_id, kwargs=kwargs
            )
        elif room_name:
            return self.__call_api_get(
    ...
    def im_members(self, room_id, **kwargs):
        ...
        return self.__call_api_get('im.members', roomId=room_id, args=kwargs)

    def im_messages(self, room_id=None, username=None, **kwargs):
        """Retrieves direct messages from the server by username"""
        if room_id:
            return self.__call_api_get(
                'im.messages', roomId=room_id, args=kwargs
            )

        if username:
            return self.__call_api_get(
                'im.messages', username=username, args=kwargs
            )
    ...
    def im_files(self, room_id=None, user_name=None, **kwargs):
        ...
        if room_id:
            return self.__call_api_get(
                'im.files', roomId=room_id, kwargs=kwargs
            )
        elif user_name:
            return self.__call_api_get(
    ...
    def im_counters(self, room_id=None, user_name=None, **kwargs):
        ...
        if room_id:
            return self.__call_api_get(
                'im.counters', roomId=room_id, kwargs=kwargs
            )
        elif user_name:
            return self.__call_api_get(
                'im.counters', username=user_name, kwargs=kwargs
            )
        else:
            raise RocketMissingParamException('roomId or username required')
    ...
    def subscriptions_get_one(self, room_id, **kwargs):
        ...
        return self.__call_api_get(
            'subscriptions.getOne', roomId=room_id, kwargs=kwargs
        )

    def subscriptions_unread(self, room_id, **kwargs):
        """Mark messages as unread by roomId or from a message"""
        return self.__call_api_post(
            'subscriptions.unread', roomId=room_id, kwargs=kwargs
        )

    def subscriptions_read(self, rid, **kwargs):
        """Mark room as read"""
        return self.__call_api_post(
            'subscriptions.read', rid=rid, kwargs=kwargs
        )
